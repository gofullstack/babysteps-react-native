...
export const API_FETCH_MILESTONES_LAST_UPDATED_PENDING = 'api_fetch_milestones_last_updated_pending';
export const API_FETCH_MILESTONES_LAST_UPDATED_FULFILLED = 'api_fetch_milestones_last_updated_fulfilled';
export const API_FETCH_MILESTONES_LAST_UPDATED_REJECTED = 'api_fetch_milestones_last_updated_rejected';
...
export const API_FETCH_MILESTONE_CALENDAR_LAST_UPDATED_PENDING = 'api_fetch_milestone_calendar_last_updated_pending';
export const API_FETCH_MILESTONE_CALENDAR_LAST_UPDATED_FULFILLED = 'api_fetch_milestone_calendar_last_updated_fulfilled';
export const API_FETCH_MILESTONE_CALENDAR_LAST_UPDATED_REJECTED = 'api_fetch_milestone_calendar_last_updated_rejected';
...
export const API_UPDATE_MILESTONE_CALENDAR_REJECTED = 'api_update_milestone_calendar_rejected';
...
export const API_FETCH_MILESTONE_CHOICE_ANSWERS_REJECTED = 'api_fetch_milestone_choice_answer_rejected';
...
export const API_SYNC_MILESTONE_ANSWERS_PENDING = 'api_sync_milestone_answers_pending';
...
export const API_FETCH_RESPONDENT_ATTACHMENTS_REJECTED = 'api_fetch_respondent_attachment_rejected';

export const API_CREATE_RESPONDENT_PENDING = 'api_create_respondent_pending';
export const API_CREATE_RESPONDENT_FULFILLED = 'api_create_respondent_fulfilled';
export const API_CREATE_RESPONDENT_REJECTED = 'api_create_respondent_rejected';
...
export const API_FETCH_USER_SUBJECT_PENDING = 'api_fetch_user_subject_pending';
export const API_FETCH_USER_SUBJECT_FULFILLED = 'api_fetch_user_subject_fulfilled';
export const API_FETCH_USER_SUBJECT_REJECTED = 'api_fetch_user_subject_rejected';
